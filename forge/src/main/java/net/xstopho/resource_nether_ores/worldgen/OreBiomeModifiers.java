...
public class OreBiomeModifiers {
    ...
    private static void addModifier(ResourceKey<BiomeModifier> modifier, ResourceKey<PlacedFeature> feature) {
        contextModifier.register(modifier, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
    ...
    private static ResourceKey<BiomeModifier> createKey(String id) {
        return ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, ResourceLocation.fromNamespaceAndPath(OreConstants.MOD_ID, id));
    }
}
