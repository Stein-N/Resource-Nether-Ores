...
public class OreBiomeModifiers {
    ...
    public static void bootstrap(BootstrapContext<BiomeModifier> context) {
        ...
        addModifier(context, ADD_NETHER_COAL_ORE, OrePlacedFeatures.NETHER_COAL_ORE_FEATURE);
        addModifier(context, ADD_NETHER_COPPER_ORE, OrePlacedFeatures.NETHER_COPPER_ORE_FEATURE);
        addModifier(context, ADD_NETHER_DIAMOND_ORE, OrePlacedFeatures.NETHER_DIAMOND_ORE_FEATURE);
        addModifier(context, ADD_NETHER_EMERALD_ORE, OrePlacedFeatures.NETHER_EMERALD_ORE_FEATURE);
        addModifier(context, ADD_NETHER_IRON_ORE, OrePlacedFeatures.NETHER_IRON_ORE_FEATURE);
        addModifier(context, ADD_NETHER_LAPIS_ORE, OrePlacedFeatures.NETHER_LAPIS_ORE_FEATURE);
        addModifier(context, ADD_NETHER_REDSTONE_ORE, OrePlacedFeatures.NETHER_REDSTONE_ORE_FEATURE);
    }

    private static void addModifier(BootstrapContext<BiomeModifier> context, ResourceKey<BiomeModifier> modifier, ResourceKey<PlacedFeature> feature) {
