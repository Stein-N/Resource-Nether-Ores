package net.morthen.resource_nether_ores.worldgen;
...
import net.morthen.resource_nether_ores.worldgen.util.OrePlacementUtil;
...
public class OrePlacedFeatures {
    ...
    private static ResourceKey<PlacedFeature> createKey(String id) {
        return ResourceKey.create(Registries.PLACED_FEATURE, Identifier.fromNamespaceAndPath(OreConstants.MOD_ID, id));
    }
